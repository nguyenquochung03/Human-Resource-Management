    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaDotTraLuong = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TenDotTraLuong = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ThangDotTraLuong = table.Column<int>(type: "int", nullable: false),
                    NamDotTraLuong = table.Column<int>(type: "int", nullable: false),
                    TongNhanVienCanPhaiTra = table.Column<int>(type: "int", nullable: false),
                    TongNhanVienDaTra = table.Column<int>(type: "int", nullable: false),
                    TongNhanVienConPhaiTra = table.Column<int>(type: "int", nullable: false),
                    TongTienCanPhaiTra = table.Column<double>(type: "float", nullable: false),
                    TongTienDaTra = table.Column<double>(type: "float", nullable: false),
                    TongTienConPhaiTra = table.Column<double>(type: "float", nullable: false),
                    NguoiTraLuong = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LoaiLich = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThangTinhLuong = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaoHienYTe = table.Column<double>(type: "float", nullable: false),
                    BaoHiemThatNghiep = table.Column<double>(type: "float", nullable: false),
                    ...
                    ThangTinhThue = table.Column<int>(type: "int", nullable: false),
                    NamTinhThue = table.Column<int>(type: "int", nullable: false),
                    NhanVienId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThuongNhanViens", x => new { x.NhanVienId, x.ThuongId, x.LanThu });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaTraLuong = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TrangThai = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NhanVienId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DotTraLuongId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
