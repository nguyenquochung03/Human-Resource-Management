...
export default function EditHieuSuatModal({ isOpen, handleCancel, handleConfirm, selectedHieuSuat, onHieuSuatUpdated }: EditHieuSuatModalProps) {

    const [employees, setEmployees] = useState<Employee[]>([]);

    const onSubmit = async (values: HieuSuat, actions: FormikHelpers<HieuSuat>) => {
        console.log(values)
        const response = await HieuSuatService.edit(values.maHieuSuat, values);
                                        ...
                                        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        value={formik.values.maHieuSuat}
                                                    ...
                                                    />
                                                    {formik.errors.maHieuSuat && formik.touched.maHieuSuat && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.maHieuSuat}</p>}
                                                </div>
