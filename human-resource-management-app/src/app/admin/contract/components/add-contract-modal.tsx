...
import AddContractModalProps from './add-contract-modal-props';
import contractService from '@/services/contractService';
import Contract from '@/models/contract';
import contractSchema from '@/schemas/contractSchema';


export default function AddContractModal({ isOpen, handleCancel, handleConfirm, onContractCreated }: AddContractModalProps) {

    const [employees, setEmployees] = useState<Employee[]>([]);

    const onSubmit = async (values: Contract, actions: FormikHelpers<Contract>) => {
        console.log(values)
        const response = await contractService.add(values);
