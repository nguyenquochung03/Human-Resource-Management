...
import AddAllowanceModalProps from './add-allowance-modal-prop';
import Allowance from '@/models/allowance';
import allowanceService from '@/services/allowanceService';
import { allowanceSchema } from '@/schemas/allowanceSchema';


export default function AddAllowanceModal({ isOpen, handleCancel, handleConfirm, onAllowanceCreated }: AddAllowanceModalProps) {

    const onSubmit = async (values: Allowance, actions: FormikHelpers<Allowance>) => {
        console.log(values)
        const response = await allowanceService.add(values);
