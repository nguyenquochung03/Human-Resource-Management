...
export default function AddAbsenceModal({ isOpen, handleCancel, handleConfirm, onAbsenceCreated }: AddAbsenceModalProps) {

    const [employees, setEmployees] = useState<Employee[]>([]);

    const onSubmit = async (values: Absence, actions: FormikHelpers<Absence>) => {
        const response = await absenceService.add(values);
