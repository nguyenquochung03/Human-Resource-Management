...
import EditChamCongModalProps from './edit-chamcong-modal-prop';


export default function EditChamCongModal({ isOpen, handleCancel, handleConfirm, selectedChamCong, onChamCongUpdated }: EditChamCongModalProps) {

    const [employees, setEmployees] = useState<Employee[]>([]);

    const onSubmit = async (values: ChamCong, actions: FormikHelpers<ChamCong>) => {
        const response = await chamCongService.edit(values.maChamCong, values);
                                        ...
                                        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        value={formik.values.maChamCong}
                                                    ...
                                                    />
                                                    {formik.errors.maChamCong && formik.touched.maChamCong && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.maChamCong}</p>}
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="py-3 px-4 block w-full border-[1px] outline-none border-slate-400 rounded-md text-sm"
                                                    />
                                                    {formik.errors.gioVaoLam && formik.touched.gioVaoLam && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.gioVaoLam}</p>}
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        value={formik.values.gioRaLam}
                                                        onChange={formik.handleChange}
                                                        type="time"
                                                        id="gioRaLam"
                                                        name="gioRaLam"
                                                        min={formik.values.gioVaoLam}
                                                        placeholder='Vd: abc@gmail.com'
                                                        className="py-3 px-4 block w-full border-[1px] outline-none border-slate-400 rounded-md text-sm"
                                                    />
                                                    {formik.errors.gioRaLam && formik.touched.gioRaLam && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.gioRaLam}</p>}
                                                </div>
