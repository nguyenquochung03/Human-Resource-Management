...
import EditEducationModalProps from './edit-education-modal-props';
import { educationSchema } from '@/schemas/educationSchema';


export default function EditEducationModal({ isOpen, handleCancel, handleConfirm, selectedEducation, onEducationUpdated }: EditEducationModalProps) {

    const [employees, setEmployees] = useState<Employee[]>([]);

    const onSubmit = async (values: Education, actions: FormikHelpers<Education>) => {
        const response = await educationService.edit(values.maTrinhDo, values);
