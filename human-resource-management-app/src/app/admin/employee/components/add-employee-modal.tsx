...
export default function AddEmployeeModal({ isOpen, handleCancel, handleConfirm, onEmployeeCreated }: Readonly<AddEmployeeModalProps>) { // Thay thế AddPositionModalProps bằng AddEmployeeModalProps
    ...
    const getPositions = async (phongBanId: string) => {
        const response = await positionService.findAllByDepartmentId(phongBanId);
        if (response?.statusCode === 200) {
    ...
    const handlePhongBanChange = (e: any) => {
                                    ...
                                    <form onSubmit={formik.handleSubmit} className="mt-5">
                                        <div className="grid grid-cols-3 gap-x-6 gap-y-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        id="phongBanId"
                                                        name="phongBanId"
                                                        className="py-3 px-4 outline-none block w-full border-[1px] border-slate-400 rounded-md text-sm"
                                                    >
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        disabled={!formik.values.phongBanId}
                                                        id="chucVuId"
                                                        name="chucVuId"
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="py-3 px-4 block w-full border-[1px] border-slate-400 outline-none rounded-md text-sm"
                                                    />
                                                    {formik.errors.hoTen && formik.touched.hoTen && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.hoTen as string}</p>}
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="py-3 px-4 block w-full border-[1px] border-slate-400 outline-none rounded-md text-sm"
                                                    />
                                                    {formik.errors.cccd && formik.touched.cccd && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.cccd as string}</p>}
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <select
                                                        value={formik.values.trangThaiHonNhan}
                                                        onChange={formik.handleChange}
                                                        id="trangThaiHonNhan"
                                                        name="trangThaiHonNhan"
                                                        className="py-3 px-4 block w-full border-[1px] border-slate-400 outline-none rounded-md text-sm"
                                                    >
                                                        <option value="default">-----Chọn trạng thái hôn nhân ----</option>
                                                        <option value="Đang hôn nhân">Đang hôn nhân</option>
                                                        <option value="Không hôn nhân">Không hôn nhân</option>
                                                    </select>
                                                    {formik.errors.trangThaiHonNhan && formik.touched.trangThaiHonNhan && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.trangThaiHonNhan}</p>}
                                                </div>

                                            </div>
                                            <div>
                                                <label
                                                    htmlFor="soNguoiPhuThuoc"
                                                    className="block text-sm font-bold ml-1 mb-2"
                                                >
                                                    Số người phụ thuộc
                                                </label>
                                                <div className="relative">
                                                    <input
                                                        value={formik.values.soNguoiPhuThuoc}
                                                        onChange={formik.handleChange}
                                                        type="number"
                                                        id="soNguoiPhuThuoc"
                                                        ...
                                                        className="py-3 px-4 block w-full border-[1px] border-slate-400 outline-none rounded-md text-sm"
                                                    />
                                                    {formik.errors.soNguoiPhuThuoc && formik.touched.soNguoiPhuThuoc && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.soNguoiPhuThuoc}</p>}
                                                </div>
