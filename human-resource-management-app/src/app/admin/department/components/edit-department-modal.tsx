...
export default function EditDepartmentModal({ isOpen, handleCancel, handleConfirm, selectedDepartment, onDepartmentUpdated }: EditModalProps) {

    const onSubmit = async (values: Department, actions: FormikHelpers<Department>) => {
        const response = await departmentService.edit(values.soPhong, values);
                                        ...
                                        <div className="flex flex-col gap-y-4">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    />
                                                    {formik.errors.soPhong && formik.touched.soPhong && <p className='text-[13px] text-red-600 mt-1 pl-2'>{formik.errors.soPhong}</p>}
                                                </div>
